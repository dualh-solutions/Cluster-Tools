...
- [Image Compressor](/tools/image/image-compressor) — reduce file size after resizing.
- [Image Cropper](/tools/image/image-cropper) — crop to a specific region instead of scaling.
- [JPG to WebP](/tools/image/jpg-to-webp) — after resizing, convert to WebP for optimal web performance.
- [Compress PDF](/tools/pdf/compress-pdf) — if your resized images are going into a PDF, compress the PDF afterward.
