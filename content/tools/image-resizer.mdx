...
**How can I make the file size even smaller after resizing?**
Resizing reduces dimensions, which naturally reduces file size. However, if you need to hit a specific file size limit, you can run your resized image through our [jpeg compressor to 200kb](/tools/image/image-compressor) tool to optimize the file size without losing visual quality.
