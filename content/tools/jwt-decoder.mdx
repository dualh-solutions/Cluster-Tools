...
- [Base64 Encoder/Decoder](/tools/developer/base64-encoder-decoder) — decode individual Base64URL components manually.
- [JSON Formatter](/tools/developer/json-formatter) — format the decoded payload JSON for readability.
- [URL Encoder/Decoder](/tools/developer/url-encoder-decoder) — decode URL-encoded strings that sometimes appear in token parameters.
- [Password Generator](/tools/developer/password-generator) — generate cryptographically secure secrets for JWT signing.
