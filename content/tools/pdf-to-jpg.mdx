...
- [Compress PDF](/tools/pdf/compress-pdf) — reduce the file size of a PDF before sharing or archiving.
- [Extract PDF Pages](/tools/pdf/extract-pdf-pages) — save specific pages from a large PDF as a new, smaller PDF.
- [Merge PDF](/tools/pdf/merge-pdf) — combine multiple PDF files into one document.
- [Image Compressor](/tools/image/image-compressor) — if the JPGs you downloaded are too large, compress them further.
