...
- [Word Counter](/tools/text/word-counter) — count words and lines before and after deduplication.
- [Text Diff Checker](/tools/text/text-diff-checker) — compare before and after to see what was removed.
- [Case Converter](/tools/text/case-converter) — normalize case before deduplication for more accurate results.
- [JSON Formatter](/tools/developer/json-formatter) — if your duplicates are in JSON format rather than plain text.
