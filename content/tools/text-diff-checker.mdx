...
- [Word Counter](/tools/text/word-counter) — count words in each version before comparing.
- [Remove Duplicate Lines](/tools/text/remove-duplicate-lines) — clean up text before diffing.
- [JSON Formatter](/tools/developer/json-formatter) — format JSON from both versions before comparing them.
- [Case Converter](/tools/text/case-converter) — normalize capitalization before comparing.
