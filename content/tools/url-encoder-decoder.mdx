...
- [Base64 Encoder/Decoder](/tools/developer/base64-encoder-decoder) — encode binary data or text to Base64.
- [JSON Formatter](/tools/developer/json-formatter) — format JSON that often appears in decoded URL parameters.
- [Slug Generator](/tools/seo/slug-generator) — generate URL-safe slugs from titles.
- [Keyword Density Checker](/tools/seo/keyword-density-checker) — analyze text from URLs and landing pages.
