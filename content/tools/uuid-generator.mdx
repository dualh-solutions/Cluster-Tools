...
- [Password Generator](/tools/developer/password-generator) — generate secure random strings for secrets and API keys.
- [Base64 Encoder/Decoder](/tools/developer/base64-encoder-decoder) — encode UUID bytes as Base64 for compact storage.
- [JSON Formatter](/tools/developer/json-formatter) — format JSON documents that include UUID fields.
